...
dir="/home/teo/Documents/Radboud/Internship"
...
trottaj_step=1			#trottaj_step value
k_over_j=0.1				#K/J
d_over_j=0.1				#D/J
#-----------------------------------------------------------------------
...
sed -i "31s/.*/tottraj_step   	$timestep/" $dir/UppASD/2d_skyrmion/inpsd.dat
...
#run UppASD
cd /home/teo/Documents/Radboud/Internship/UppASD/2d_skyrmion
rm *.out
